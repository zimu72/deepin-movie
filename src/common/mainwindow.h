...
private:
    ...
    */
    ...
    void updateAuxProgressBarVisibility();
    void updateAuxProgressBarGeometry();
    void updateAuxProgressBarTime();
    void applyAuxProgressSliderStyle();
...
private:
    ...
    QWidget *m_pAuxProgressBar {nullptr};
    QWidget *m_pAuxProgressTrackBg {nullptr};
    DMRSlider *m_pAuxProgressSlider {nullptr};
    QLabel *m_pAuxProgressTime {nullptr};
    QGraphicsOpacityEffect *m_pAuxProgressOpacity {nullptr};
    bool m_bAuxProgressDragging {false};
};
};
